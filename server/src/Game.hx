...
class Game
{
	...
	public function new(id:Int, mapId:Int,extension:HaxeExtension) 
	{
		this.id = id;
		this.mapId = mapId;
	...
	public static function removeUserFromGame(user:User, room:Room, extension:HaxeExtension)
	{
		java.Lib.lock(mutex,{
			if (room != null)
